...
<html lang="en">
  ...
  ?>
  <h2>View Records
    <a href="addproduct.php" class="btn btn-primary" style="float:right;">Add New Record</a>
  </h2>
  <table class="table table-hover">
    ...
    <tbody>
        ...
        <tr>
          ...
          <td>
            <a href="updateprod.php?editId=<?php echo $prod['id'] ?>" style="color:green">
              <i class="fa fa-pencil" aria-hidden="true"></i></a>&nbsp
            <a href="products.php?deleteId=<?php echo $prod['id'] ?>" style="color:red" onclick="confirm('Are you sure want to delete this record')">
